...
class AlbumCover():
    ...
    def __init__(self):
        self.init_url = "https://music.163.com/#/artist/album?id=12184145&limit=51&offset=0" #请求网址
        self.folder_path = "E:\\mathroom\\music-visualization\\album_pictures" #想要存放的文件目录
    ...
    def spider(self):
        ...
        for li in all_li:
            ...
            photo_name = "".join(photo_name.split(" "))
